...
void Mage::display() const {
    ...
    std::cout << "School of Magic: " << getSchool() << std::endl;
    std::cout << "Weapon: " << getCastingWeapon() << std::endl;
    std::cout << "They " << (hasIncarnateSummon() ? "can" : "cannot") << " summon an Incarnate." << std::endl;
    std::cout << std::endl;
